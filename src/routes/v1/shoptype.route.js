 ...
 * tags:
 *   name: ShopType
 *   description: Shop type management and retrieval
 */
 ...
 *     description: Change the name of the shop type.
 *     tags: [ShopType]
 *     security:
 *       - bearerAuth: []
 *     parameters:
